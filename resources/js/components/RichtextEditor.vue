<template>
    <div>
        ...
        <button ref="emojiBtn" @click="showEmoji($event)" class="btn-inline1 _emojibtn"><i class="fa fa-smile-o _emojibtn"></i></button>
        <button :title="box.title" v-for="box in boxStyles"
                :style="box.buttonStyle"
                @click="addBlock(box)"  class="btn-inline1">a</button>
...
`, buttonStyle: `border: 2px dashed #47c7e4;
    ...
    export default {
     ...
     /*           const offset = $(e.target).offset();
        ...
        props: ['id', 'value', 'upload', 'height', 'default'],
        destroyed() {
        },
        mounted: function () {
