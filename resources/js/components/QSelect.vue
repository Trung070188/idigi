    ...
    <div class="qselect" ref="wrapper"  >
        ...
        <div class="qselect-dropdown" ref="dropdown" :style="{display: this.showDropDown ? 'block' : 'none'}" >
            <ul ref="dropDownUl" v-if="options.length">
                <li @click="select(o)" class="qselect-item"
                    v-for="(o,index) in options" v-if="o.show"
                    @mouseover="onMouseOver(index)"
                    :class="{active: focusIndex===index, last: index === options.length - 1}"
                >
...
<script>
    ...
    export default {
        props: ['value', 'multiple', 'defaultOptions', 'datasource', 'search',
        ...
        methods: {
            ...
            onChange() {
                ...
                if (this.isMultiple) {
                    ...
                    this.$emit('input', this.model[0] || null)
        ...
        data() {
            ...
            if (isMultiple) {
                ...
                if (Array.isArray(this.value)) {
                    ...
                    value = this.value.length ? this.value[0] : null;
                }
