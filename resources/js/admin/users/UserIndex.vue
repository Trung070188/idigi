...
<!--                           </div>-->
                        ...
                        <table class="table table-row-bordered align-middle gy-4 gs-9">
                            ...
                            <tr v-for="(entry,index) in entries">
                                ...
                                <td class="" >
                                    <a href="list.html#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" v-if="permissions['002'] || permissions['003']">Actions
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3" v-if="permissions['002']">
                                            <a  :href="'/xadmin/users/edit?id='+entry.id" class="menu-link px-3">Edit</a>
                                        </div>
                                        <div class="menu-item px-3" v-if="permissions['003']">
                                            <a class="menu-link text-danger px-3" v-if="entry.role!=='Super Administrator'" @click="removeUser(entry.id)" data-kt-subscriptions-table-filter="delete_row">Delete</a>
                                            <a class="menu-link text-danger px-3" v-if=" entry.role=='Super Administrator'"  @click="modalDevice()" data-kt-subscriptions-table-filter="delete_row">Delete</a>
