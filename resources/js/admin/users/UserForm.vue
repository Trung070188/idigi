                    ...
                    <div class="card-body d-flex flex-column">
                                ...
                                <div class="row">
                                    <div v-if="errors!==''" class="form-group col-sm-4">
                                        ...
                                        <input class="form-control nospace" placeholder="Enter the username"
                                               v-model="entry.username" @input="disableSave(entry)">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input class="form-control" placeholder="Enter the full name"
                                               v-model="entry.full_name" @input="disableSave(entry)">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input class="form-control" placeholder="Enter the email address"
                                               v-model="entry.email" @input="disableSave(entry)">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-start mt-2">
                                            <div class="form-check form-check-custom form-check-solid mr-10"
                                                 v-for="role in roles">
                                                <input type="radio" class="form-check-input mr-2" v-model="name_role"
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12 mb-5">
                                        ...
                                        <textarea v-model="entry.description" rows="5" class="form-control"
                                                  placeholder="Type the description here (200 characters)"
                                                  @input="disableSave(entry)"></textarea>
                        ...
                        <div class="mt-5">
                            <button type="reset" @click="save()" class="btn btn-primary mr-3"
                                    :disabled="disableSave(entry)"><i class="bi bi-send mr-1"></i>Submit
                            </button>
...
export default {
    ...
    methods: {
        ...
        async save() {
            ...
            this.$loading(true);
            const res = await $post('/xadmin/users/save', {
                entry: this.entry,
