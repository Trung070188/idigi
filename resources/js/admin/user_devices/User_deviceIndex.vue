                ...
                <div class="modal-content box-shadow-main paymment-status" style="margin-right:20px; left:140px">
                    ...
                    <div class="px-10 py-5 text-left">
                        <p>
                            ...
                            Open iSMART DIGI application on your device.
                        </p>
                        <p>
                            <span class="svg svg-icon mr-2">
                            ...
                            Click on button "Get device information" and copy "Register Code".
                        </p>
                        <p>
                            <span class="svg svg-icon mr-2">
                            ...
                            Paste it to the following input field.
                        </p>
