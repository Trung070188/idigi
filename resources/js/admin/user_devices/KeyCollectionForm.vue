<template>
    <div class="container-fluid">
        <ActionBar type="index"
                   :breadcrumbs="breadcrumbs" title = "Create new key collection"/>
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="d-flex flex-stack pt-4 pl-9 pr-9">
                                ...
                                <div class="d-flex justify-content-end" style="margin: 0px -25px 0px">
                                    <button style="margin:0px 20px 0px" type="button" class="btn btn-primary" @click="importDevice()" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app"> Import device

                                    </button>
                                    <button type="button" class="btn btn-primary" > Add device
                                    </button>
                                </div>
                            </div>
