                ...
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            >
                                <a :href="'/xadmin/user_devices/createKeyCollection'">
                                    <button   type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer" >Create New Key Collection</button>
