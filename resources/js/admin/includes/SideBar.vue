<template>
    ...
    <div style="background:#C8C8C8" id="kt_aside" class="aside aside-hoverable" data-kt-drawer="true"
         data-kt-drawer-name="aside"
         data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true"
         data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start"
         data-kt-drawer-toggle="#kt_aside_mobile_toggle">
        <div style="background: #C8C8C8" class="aside-logo flex-column-auto" id="kt_aside_logo">
            <a href="/">
                        ...
                        <div data-kt-menu-trigger="click" :class="{'show': menu.active ,'here': menu.active}"
                            ...
                            <span class="menu-link">
                                <span class="menu-icon">
                                    <i :class="menu.icon" style="width: 20px;color: #000000"></i>
                                </span>
