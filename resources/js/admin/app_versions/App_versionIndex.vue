<template>
    <div class="container-fluid">
        ...
        <div class="card card-custom card-stretch gutter-b"
             v-if="role=='Super Administrator' ||  role=='Administrator'">
                ...
                <div id="kt_billing_months" class="card-body p-0 tab-pane fade show active" role="tabpanel"
                    ...
                    <table class="table table-row-bordered align-middle gy-4 gs-9">
                        ...
                        <tr v-for="entry in entries" v-if="entry.type=='window'">
                            ...
                            <td class="css_test" v-text="entry.release_note" v-if="entry.release_note!=NULL"
            ...
            <div class="card-body d-flex flex-column" style="height: 563px">
                ...
                <div class="col-lg-12" style="text-align: center;padding: 0 114px;">
                    <div v-for="entry in entries" v-if="entry.type=='window'&& entry.is_default==1" style="">
                        ...
                        <a href="javascript:;" @click="downloadApp" >
...
<script>
    ...
    export default {
        ...
        methods: {
            async downloadApp(){
                const res = await $get('/xadmin/app_versions/downloadApp');
