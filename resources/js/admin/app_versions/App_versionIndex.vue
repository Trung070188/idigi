        ...
        <div class="row">
            <div class="col-lg-12">
                <div v-if="role=='Super Administrator'" class="card card-custom card-stretch gutter-b">
                    ...
                    <div id="accordion">
                        <div class="card">
                            <div class="card-header" id="headingOne" style="min-height: auto;">
                                <h5 class="mb-0">
                                    <button class="btn btn-link btn-border" data-toggle="collapse"
                                            data-target="#collapseOne"
                                            aria-expanded="true" aria-controls="collapseOne">
                                        <span class="fw-bolder fs-5 mb-0">Application for window({{ totalVersionWindow }} version)</span>
                                    </button>
                                </h5>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingTwo" style="min-height: auto;">
                                <h5 class="mb-0">
                                    <button class="btn btn-link collapsed btn-border" data-toggle="collapse"
                                            data-target="#collapseTwo" aria-expanded="false"
                                            aria-controls="collapseTwo">
                                        <span class="fw-bolder fs-5 mb-0">Application for MacOs({{ totalVersionIos }} version)</span>
                                    </button>
                                </h5>
                            </div>
