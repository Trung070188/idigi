<template>
    <div class="container-fluid">
        <ActionBar type="index"
                   :breadcrumbs="breadcrumbs" title="Notifications"/>
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base" v-if="notificationIds == ''">
                    ...
                    <div class="tab-content">
                        ...
                        <table class="table table-row-bordered align-middle gy-4 gs-9">
                            ...
                            <tr v-for="entry in entries">
                                ...
                                <td class="" v-if="entry.title==='File download plan'">File download plan</td>
                                <td class="" >
