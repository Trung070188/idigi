<template>
    <div class="container-fluid">
        <ActionBar type="index" :breadcrumbs="breadcrumbs" title="Teacher details" />
        ...
        <div class="modal fade" style="" id="deviceConfirm" tabindex="-1" role="dialog" aria-labelledby="deviceConfirm"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered popup-main-1" role="document" style="max-width: 450px;">
                <div class="modal-content box-shadow-main paymment-status" style="padding: 0px 0px 30px;">
                    <div class="close-popup" data-dismiss="modal"></div>
                    ...
                    <div class="swal2-actions">
                        <button type="reset" id="kt_modal_new_target_cancel1"
                            class="swal2-cancel btn fw-bold btn-active-light-primary" data-bs-dismiss="modal"
                            style="margin: 0px 8px 0px" @click="refuse(deviceTeacher)">Refuse</button>

                        <button type="submit" class="swal2-confirm btn fw-bold btn-danger"
                            @click="remove_device(deviceTeacher)">
                            <span class="indicator-label">Yes, delete!</span>
                        </button>
                    </div>
                </div>
                ...
                <div class="card card-custom card-stretch gutter-b">
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <button class="btn btn-danger button-create " @click="removeTeacher" style="margin: 15px 25px 0px "
                            :disabled="!permissionFields['teacher_delete']">
                    ...
                    <div class="card-body d-flex flex-column">
                            ...
                            <div class=" col-sm-12">
                                ...
                                <div class="row">
                                    <div class="form-group  col-sm-4">
                                        ...
                                        <input class="form-control" v-model="entry.username"
                                            :disabled="!permissionFields['teacher_username']">
                                    ...
                                    <div class="form-group  col-sm-4">
                                        ...
                                        <input class="form-control" v-model="entry.full_name"
                                            :disabled="!permissionFields['teacher_full_name']">
                                    ...
                                    <div class="form-group  col-sm-4">
                                        ...
                                        <input class="form-control" v-model="entry.email"
                                            :disabled="!permissionFields['teacher_email']">
                                    ...
                                    <div class="form-group  col-sm-4">
                                        ...
                                        <input class="form-control noString" v-model="entry.phone"
                                            :disabled="!permissionFields['teacher_phone']">
                                        <error-label for="f_category_id" :errors="errors.phone"></error-label>
                                    </div>
                                    <div class="form-group  col-sm-4">
                                        <label>Class</label>
                                        <input class="form-control" v-model="entry.class"
                                            :disabled="!permissionFields['teacher_class']">
                                        <error-label for="f_category_id" :errors="errors.class"></error-label>
                                    </div>
                                    <div class="form-group col-sm-4">
                                        <label>School</label>
                                        <input class="form-control form-control-solid" v-model="schools.label"
                                            :disabled="!permissionFields['teacher_school']">
                                        <error-label for="f_category_id" :errors="errors.label"></error-label>
                                    </div>
                                    <div class="form-group  col-sm-4">
                                        <label>Password <span class="text-danger">*</span></label>
                                        <input :type="showPass ? 'text' : 'password'" class="form-control" ref="password"
                                            v-model="password" placeholder="Enter the password"
                                            :disabled="!permissionFields['password']">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid ml-3 pb-5">
                                        <input id="state" type="checkbox" v-model="entry.state"
                                            ...
                                            :disabled="!permissionFields['active_teacher']">
                                    ...
                                    <div class="row">
                                        <div class="row">
                                            ...
                                            <h3 style="text-align: center; font-weight: bold;font-size: 15px">Resource
                                                allocation has been deactivated by Super admin </h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="row" v-if="school.active_allocation == 1">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <treeselect :options="allCourses" :multiple="true" @deselect="deleteCourse"
                                            v-model="courseTeachersTmp" @input="selectTotalCourse"
                                            :disabled="!permissionFields['resource_allocation']" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12" style="display: flex ;margin: 16px 0px 0px"
                                        v-for="courseTeacher in courseTeachers">
                                        <div v-for="course in courses" v-if="courseTeacher == course.id"
                                            style="display: flex;align-items: center;flex-basis: 10%"> {{ course.label }}
                                        </div>
                                        <div v-for="course in courses" v-if="courseTeacher == course.id"
                                            style="flex-basis: 90%">
                                            <treeselect :options="course.total_unit" :multiple="true"
                                                v-model="course.courseTeaTmp" @input="selectTotalUnit(course)"
                                                :disabled="!permissionFields['resource_allocation']" />
                                ...
                                <div class="form-check form-check-custom form-check-solid mt-3"
                                    v-if="school.active_allocation == 1">
                                    <input id="state1" type="checkbox" v-model="active_allocation"
                                        class="form-check-input h-20px w-20px" @change="activeAllocation"
                                        :disabled="!permissionFields['active_allocation']">
                        ...
                        <div>
                            <button type="reset" @click="save()" class="btn btn-primary mr-2"><i
                                    class="bi bi-save2 mr-1"></i>Save</button>
                        ...
                        <table class="table table-row-bordered align-middle gy-4 gs-9">
                            ...
                            <tbody>
                                <tr v-for="(device, index) in userDevices">
                                    ...
                                    <td style="color: #f1c40f" v-if="device.delete_request != null"
                                        v-text="device.delete_request"></td>
                                    <td v-else></td>
                                    <td>
                                        <a v-if="permissionFields['delete_device']" @click="modalDevice(device)"
                                            href="javascript:;" class="btn-trash deleted"><i class="bi bi-trash"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<script>
import { $get, $post, forEach, clone } from "../../utils";
