<template>
    <div class="container-fluid">
        <ActionBar type="index" :breadcrumbs="breadcrumbs"
            :title="'Teacher management' + '-' + 'Trường' + ' ' + entry.label" />
        <div class="row">
            <div class="col-lg-12">
                                                            ...
                                                            <div v-if="valueValidateImportTeacher != 0"
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <div class="ms-6">
                                                                        ...
                                                                        <div class="fw-bold text-muted">{{ fileError.length
                                                                        }}
                                                                            error
                                                                            record(s)
                                                                        </div>
                                                                ...
                                                                <div class="d-flex" v-if="fileError.length > 0">
                                                                    <div class="text-end">
                                                                        <div class="fs-7 text-muted">
                                                                            <a @click="exportErrorImportTeacher"
                                                                                type="button"
                        ...
                        <div class="modal-content box-shadow-main paymment-status"
                            ...
                            <div class="swal2-actions">
                                <button type="submit" id="kt_modal_new_target_submit"
                                    class="swal2-confirm btn fw-bold btn-danger" @click="remove(idTeacher)">
                        ...
                        <div class="modal-content box-shadow-main paymment-status"
                            ...
                            <div class="swal2-actions">
                                <button type="submit" id="kt_modal_new_target_submit1"
                                    class="swal2-confirm btn fw-bold btn-danger" @click="removeAll(teacherIds)">
                                    <span class="indicator-label">Yes, delete!</span>
                                </button>
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base"
                                v-if="teacherIds == ''">
                                <button type="button" @click="isShowFilter = !isShowFilter" class="btn btn-light mr-2"
                                    v-if="isShowFilter">
                                ...
                                <button type="button" class="btn btn-primary mr-2" @click="importTeacher"
                                    v-if="permissions['050'] && isCreateTeacher == 1">
                                ...
                                <a :href="'/xadmin/users/create_teacher?schoolId=' + JSON.stringify(entry.id)"
                                    v-if="permissions['013'] && isCreateTeacher == 1">
                        ...
                        <div class="d-flex justify-content-end align-items-center d-none"
                            data-kt-customer-table-toolbar="selected" v-if="teacherIds != ''">
                            <div class="fw-bolder me-5">
                                <span class="me-2" data-kt-customer-table-select="selected_count"></span>
                                {{ teacherIds.length }} Selected
                            </div>
                            <button v-if="permissions['015']" @click="removeAllModal" type="button" class="btn btn-danger"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <input @keydown.enter="doFilter('email', filter.email, $event)" class="form-control"
                                        placeholder="Enter the teacher’s email" v-model="filter.email">
                                </div>
                                <div class="form-group col-lg-3">
                                    <label>Teacher phone number </label>
                                    <input @keydown.enter="doFilter('phone', filter.phone, $event)" class="form-control"
                                        placeholder="Enter the teacher’s phone number" v-model="filter.phone">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-3">
                                    <label>Creation time </label>
                                    <Daterangepicker v-model="filter.created" placeholder="Creation date" readonly>
                                    </Daterangepicker>
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <div style="position: relative">
                                        ...
                                        <div style="position: absolute;margin: -30px 60px 0px" v-if="filter.state == 0">No
                                        </div>
                        ...
                        <div class="d-flex flex-stack pt-4 pl-9 pr-9">
                            ...
                            <div class="badge badge-lg badge-light-dark mb-15">
                                <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    <div v-text="from + ' to ' + to + ' of ' + countTeacher" v-if="entries.length > 0">
                                    </div>
                                    ...
                                    <td class="text-center">
                                        <div
                                            ...
                                            <input v-model="entry.state" @change="toggleStatus(entry)"
                                                ...
                                                :disabled="!permissions['014']">
                                        </div>
                                    </td>
                                    <td class="text-center ">
                                        <div class="d-flex justify-content-around">
                                            <i :class="'bi bi-trash text-danger cursor-pointer action-btn action-btn-' + entry.id"
                                                v-if="permissions['015']" :title="'Delete ' + entry.name"
                                                @click="removeTeacher(entry.id)"></i>
                                        </div>
                                    </td>
                                    <!-- <td class=""> -->
...
export default {
    ...
    methods: {
        ...
        edit: function (id, permission) {
            if (permission) {
                window.location.href = '/xadmin/users/teacherDetails?id=' + id;
            }
        },
        async load() {
