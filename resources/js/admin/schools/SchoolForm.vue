            ...
            <div class="col-lg-12">
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-body d-flex flex-column">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="number" min="1" max="10000" v-model="entry.number_of_users"
                                               class="form-control noString"
                            ...
                            <div class="row">
                                <div class="form-group col-lg-8">
                                    ...
                                    <select required class="form-control form-select" v-model="allocationContentSchool"
                                            @change="changeAllocationContent()">
                                        <option value="" disabled selected>Choose resource allocation</option>
                                        <option v-for="allocationConten in allocationContens"
                                                :value="allocationConten.id">{{ allocationConten.title }}
                                        </option>
                                    </select>
                        ...
                        <div>
                            <button type="reset" @click="save()" class="btn btn-primary mr-2"><i class="bi bi-send"></i>Save
                            </button>
