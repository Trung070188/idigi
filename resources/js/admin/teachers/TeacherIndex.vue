                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base" v-if="teacherIds == ''">
                                ...
                                <a v-if="permissions['013'] && entries.length<lengthUserSchool && permissionFields['teacher_management_create_new']==false ">
                                    <button class="btn btn-primary button-create ml-0" style="margin:0 0 0 15px"> Create</button>
                                </a>
                                <a v-if="permissions['013'] && entries.length<lengthUserSchool && permissionFields['teacher_management_create_new']==true " :href="'/xadmin/users/create_teacher'">
                                    <button class="btn btn-primary button-create ml-0" style="margin:0 0 0 15px"> Create</button>
                                </a>
                                <button :disabled="permissionFields['teacher_management_create_new']==false" v-if="permissions['013'] && entries.length==lengthUserSchool "  @click="teacherFull" class="btn btn-primary button-create ml-0" style="margin:0 0 0 15px">
                                    Create
                                </button>
                                ...
                                <td class="">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a v-if="permissions['014']" :href="'/xadmin/users/editTeacher?id='+entry.id" class="menu-link px-3">Edit</a>
                                        </div>
                                        <div class="menu-item px-3" >
                                            <a class="menu-link text-danger px-3" v-if="permissions['015']" @click="removeTeacher(entry.id)" data-kt-subscriptions-table-filter="delete_row">Remove</a>
