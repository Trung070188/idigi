...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async save() {
                this.isLoading = true;
                const res = await $post('/xadmin/users/saveTeacher', {entry: this.entry, roles: this.roles,courseTeachers:this.courseTeachers,unit:this.courses,name_role:this.nameRole,allocationContentId:this.allocationContentId}, false);
