                ...
                <div class="modal-content box-shadow-main paymment-status" style="padding: 0px 0px 30px;">
                    ...
                    <div class="swal2-actions">
                        <button type="reset" id="kt_modal_new_target_cancel1"
                            ...
                            style="margin: 0px 8px 0px">Refuse</button>
            ...
            <div class="col-lg-12">
                <div class="card card-custom card-stretch gutter-b">
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <button class="btn btn-danger button-create " @click="removeTeacher()"
                                ...
                                <div class="row">
                                    <div class="form-group  col-sm-4">
                                        ...
                                        <input class="form-control" v-model="entry.username"
                                            :disabled="permissionFields['teacher_username'] == false">
                                    ...
                                    <div class="form-group  col-sm-4">
                                        ...
                                        <input class="form-control" v-model="entry.email"
                                            :disabled="permissionFields['teacher_email'] == false">
                                    ...
                                    <div class="form-group  col-sm-4">
                                        ...
                                        <input class="form-control noString" v-model="entry.phone"
                                            :disabled="permissionFields['teacher_phone'] == false">
                                        <error-label for="f_category_id" :errors="errors.phone"></error-label>
                                    </div>
                                    <div class="form-group  col-sm-4">
                                        <label>Class</label>
                                        <input class="form-control" v-model="entry.class"
                                            :disabled="permissionFields['teacher_class'] == false">
                                        <error-label for="f_category_id" :errors="errors.class"></error-label>
                                    </div>
                                    <div class="form-group  col-sm-4">
                                        <label>School</label>
                                        <input class="form-control" v-model="schools.label"
                                            :disabled="permissionFields['teacher_school'] == false">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-8">
                                            ...
                                            <textarea v-model="entry.description" rows="5" class="form-control"
                                                :disabled="permissionFields['teacher_description'] == false"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-10" @change="saveTeacherCourse()">
                                        ...
                                        <treeselect :options="allCourses" :multiple="true" @deselect="deleteCourse"
                                            v-model="courseTeachers" @input="selectTotalCourse" />
                                                ...
                                                <tr v-for="course in courses" v-if="courseTeacher == course.id">
                                                    ...
                                                    <td>
                                                        <treeselect :options="course.total_unit" :multiple="true"
                                                            v-model="course.courseTea" @input="selectTotalUnit(course)" />
