<template>
    <div class="container-fluid">
        <ActionBar type="index" :breadcrumbs="breadcrumbs" title="Create new teacher" />
        <div class="row">
            <div class="col-lg-12">
                            ...
                            <div class=" col-sm-12">
                                ...
                                <div class="row">
                                    <div class="form-group  col-sm-4">
                                        ...
                                        <input class="form-control nospace" placeholder="Enter the username"
                                    ...
                                    <div class="form-group  col-sm-4">
                                        <label>Email </label>
                                        <input class="form-control" placeholder="Enter the email address"
                                            v-model="entry.email">
                                        <error-label for="f_category_id" :errors="errors.email"></error-label>
                                    </div>
                                    <div class="form-group  col-sm-4">
                                        <label>Phone number </label>
                                        <input class="form-control noString" placeholder="Enter the phone number"
                                            v-model="entry.phone">
                                ...
                                <div class="row">
                                    <div v-if="entry.id == null" class="form-group  col-sm-4">
                                        ...
                                        <input v-if="auto_gen == true" disabled :type="showPass ? 'text' : 'password'"
                                            class="form-control" placeholder="Enter the password" ref="password"
                                            v-model="entry.password">
                                        <input v-if="auto_gen == false" :type="showPass ? 'text' : 'password'"
                                            class="form-control" placeholder="Enter the password" ref="password"
                                            v-model="entry.password">
                                ...
                                <div class="form-check form-check-custom form-check-solid pb-5">
                                    <input id="state1" type="checkbox" v-model="entry.state"
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <treeselect :options="courses" :multiple="true" v-model="courseTeacherTmp"
                                            @input="selectTotalCourse" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12" style="display: flex ;margin: 16px 0px 0px"
                                        ...
                                        <div v-for="course in courses[0].children" v-if="courseTeacher == course.id"
                                            style="display: flex;align-items: center;flex-basis: 10%"> {{ course.label }}
                                        </div>
                                        <div style="flex-basis: 90%" v-for="course in courses[0].children"
                                            v-if="courseTeacher == course.id">
                                            <treeselect :options="course.unit" :multiple="true"
                                                v-model="course.teacher_unit_tmp" @input="selectTotalUnit(course)" />
                                            <error-label :errors="errors.teacher_unit"></error-label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-check form-check-custom form-check-solid pb-5 mt-3">
                                    <input id="state2" type="checkbox" v-model="entry.active_allocation"
                                        class="form-check-input h-20px w-20px" checked>
    ...
    mounted() {
        ...
        async save() {
            ...
            const res = await $post('/xadmin/users/saveTeacher', {
                entry: this.entry, roles: this.roles,
