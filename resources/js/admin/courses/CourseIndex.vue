<template>
    <div class="container-fluid" >
        <ActionBar type="index"
                   createUrl="/xadmin/courses/create"
                   title="CourseIndex"/>
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <table class=" table  table-head-custom table-head-bg table-vertical-center">
                            ...
                            <tr v-for="entry in entries" @click="edit(entry.id, $event)">
                                <td v-text="entry.id"></td>
                                                                    ...
                                                                    <td v-text="entry.public_from"></td>
                                                                    <td v-text="entry.public_to"></td>
                                                                    <td v-text="entry.status"></td>
                                
                                <td class="">
<!--                                    <a :href="'/xadmin/courses/edit?id='+entry.id" style="margin-right: 10px"><i style="font-size:1.3rem" class="fa fa-edit"></i></a>-->
