<template>
    <div class="container-fluid">
        <ActionBar type="index" :breadcrumbs="breadcrumbs" title="Plan details" />
        <div class="row">
            <!-- modal cancel package lesson -->

            <div class="modal fade" style="margin-right:50px;border:2px solid #333333  " id="cancelModal" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered popup-main-1" role="document" style="max-width: 450px;">
                    <div class="modal-content box-shadow-main paymment-status"
                        ...
                        <div class="swal2-actions">
                            <button type="submit" id="kt_modal_new_target_submit2"
                                class="swal2-confirm btn fw-bold btn-primary" @click="cancelModalYes">
                                <span class="indicator-label">Yes</span>
                            </button>
                            <button type="reset" id="kt_modal_new_target_cancel2"
                                class="swal2-cancel btn fw-bold btn-active-light-primary" @click="cancelModalNo"
                                style="margin: 0px 8px 0px">No</button>
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                            ...
                            <div class="d-flex">
                                <div class="h-15px me-3" style="width: 218px">
                                    <label>Name </label>
                                    <input v-model="filter.keyword" @keydown.enter="doFilter($event)" class="form-control"
                                ...
                                <div class="mh-300px scroll-y me-n7 pe-7" style="width: 703px">
                                    <table class="table table-row-bordered align-middle gy-4 gs-9">
                                                ...
                                                <td width="25">
                                                    <div
                                                        ...
                                                        <input class="form-check-input" type="checkbox"
                                                            v-model="package.allLessonSelected" @change="selectLessonAll()">
                                                    </div>
                                                </td>
                                        ...
                                        <tbody v-for="lessonPackagePlan in lessonPackagePlans"
                                            v-if="lessonPackagePlan.package_id == package.package">
                                            <tr v-for="lesson in entries">
                                                <td class="">
                                                    <div
                                                        class="form-check form-check-sm form-check-custom form-check-solid">
                                                        <input class="form-check-input" type="checkbox"
                                                            v-model="lessonPackagePlan.lessonIds" :value="lesson.id"
                                                            @change="updateLessonAll()">
                                                    </div>
                                                </td>
            ...
            <div class="col-lg-12">
                ...
                <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-8">
                                        ...
                                        <input :disabled="!permissionFields['plan_name']" v-model="entry.name"
                                            class="form-control" placeholder="Enter the name of plan">
                                        <error-label :errors="errors.name" for="f_school_name"></error-label>
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <label>Due date </label>
                                        <Datepicker :disabled="!permissionFields['plan_due_date']" v-model="entry.due_at"
                                            readonly />
                                        <span v-if="entry.due_at != '' && permissionFields['plan_due_date']"
                                            class="svg-icon svg-icon-2 svg-icon-lg-1 me-0" @click="dueAtClear">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-8">
                                        ...
                                        <textarea :disabled="!permissionFields['plan_description']" class="form-control"
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <select :disabled="!permissionFields['plan_assign_to_IT']"
                                            class="form-control form-select" v-model="idRoleIt">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-4">
                                        ...
                                        <Datepicker :disabled="!permissionFields['plan_expire_date']"
                                            v-model="entry.expire_date" readonly />
                                        <span v-if="entry.expire_date != '' && permissionFields['plan_expire_date']"
                                            class="svg-icon svg-icon-2 svg-icon-lg-1 me-0" @click="expireDateClear">
                                            <svg type="button" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" style="float: right;margin: -32px 3px 0px;">
                                                <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1"
                                                    transform="rotate(-45 6 17.3137)" fill="black" style="fill:red" />
                                ...
                                <div class="row">
                                    <div class="card-title ">
                                        <ul class="nav nav-stretch nav-line-tabs border-transparent" role="tablist">
                                            ...
                                            <li v-for="(packageLesson, index) in lessonPackagePlans" class="nav-item"
                                                role="presentation">
                                                <a :id="'kt_billing_1year_tab' + index"
                                                    class="package-lesson-link nav-link fs-5 fw-bold me-3"
                                                    :class="packageLesson.className" data-bs-toggle="tab" role="tab"
                                                    href="#kt_billing_year"
                                                    @click="tabPackageLesson(packageLesson.package_id)">{{
                                                        packageLesson.name }}</a>
                                            </li>
                                            <li>
                                                <a :class="!permissionFields['plan_add_package'] ? 'btn btn-primary btn-active-primary btn-sm mt-2 ml-2 isDisabled' : 'btn btn-primary btn-active-primary btn-sm mt-2 ml-2'"
                                                    data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"
                                                    @click="addPackageLessonModal">Add package
                                                </a>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="kt_billing_months" class="card-body p-0 tab-pane fade show active"
                                        ...
                                        <div class="d-flex justify-content-end mb-4">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown  menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 py-4"
                                                data-kt-menu="true" style="width: 150px">
                                                <div class="menu-item px-3">
                                                    <a :class="!permissionFields['plan_add_device'] ? 'menu-link px-3 isDisabled' : 'menu-link px-3'"
                                                        @click="addDevice()">Add a device</a>

                                                </div>
                                                <div class="menu-item px-3">
                                                    <a :class="!permissionFields['plan_import_device'] ? 'menu-link px-3 isDisabled' : 'menu-link px-3'"
                                                        @click="importDevice()">Import devices</a>
                                                </div>

                                                <div class="menu-item px-3">
                                                    <a :class="(!permissionFields['plan_export_device'] || data.length == 0) ? 'menu-link px-3 isDisabled' : 'menu-link px-3'"
                                                        @click="exportDevice">Export device list</a>
                                                </div>
                                                    ...
                                                    <tr>
                                                        <td width="25">
                                                            <div
                                                                class="form-check form-check-sm form-check-custom form-check-solid">
                                                                <input class="form-check-input" type="checkbox"
                                                                    :disabled="!permissionFields['plan_delete_device']"
                                                                    v-model="allDeviceSelected" @change="selectDeviceAll()">
                                                            </div>
                                                        </td>
                                                        <td>No.</td>
                                                    ...
                                                    <tr v-for="(device, index) in data">
                                                        <td class="">
                                                            <div
                                                                ...
                                                                <input class="form-check-input" type="checkbox"
                                                                    :disabled="!permissionFields['plan_delete_device']"
                                                                    v-model="deviceIds" :value="device.id"
                                                                    @change="updateDeviceCheckAll">
                                                            </div>
                                                        </td>
                                                        <td>{{ index + 1 }}</td>
                                                        ...
                                                        <td class="">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-180px py-4"
                                                                data-kt-menu="true">
                                                                <div class="menu-item px-3">
                                                                    <a :class="!permissionFields['plan_edit_device_information'] ? 'menu-link px-3 isDisabled' : 'menu-link px-3'"
                                                                        @click="modalEditDevice(device)">Edit</a>
                                                                </div>
                                                                <div class="menu-item px-3">
                                                                    <a :class="!permissionFields['plan_device_get_confirm_code'] ? 'menu-link px-3 isDisabled' : 'menu-link px-3'"
                                                                        @click="modalConfirmationCode(device)">Get
                                                                        confirmation code</a>
                                                                </div>
                                                                <div class="menu-item px-3">
                                                                    <a :class="!permissionFields['plan_delete_device']?'menu-link text-danger px-3 isDisabled':'menu-link text-danger px-3'"
                                                                        data-kt-menu-trigger="click"
                                                                        data-kt-menu-placement="bottom-end"
                                                                        @click="removeDeviceModal(device.id)">Delete</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                    ...
                                    <div id="kt_billing_year" class="card-body p-0 tab-pane fade" role="tabpanel"
                                        ...
                                        <div class="d-flex justify-content-end mb-4">
                                            ...
                                            <a v-if="dataZipLesson.status == 'running' || dataZipLesson.status == 'inprogress'"
                                                ...
                                                packaging...</a>
                                            <a v-if="dataZipLesson.status == 'done' && permissionFields['plan_download_package'] == true"
                                                :href="dataZipLesson.url" class="btn btn-primary btn-sm mr-3 "> Download
                                                package</a>
                                            <a v-if="dataZipLesson.status == 'done' && permissionFields['plan_download_package'] == false"
                                                :href="dataZipLesson.url" class="btn btn-primary btn-sm mr-3 isDisabled">
                                                Download package</a>
                                            <a v-if="dataZipLesson.status == 'running' || dataZipLesson.status == 'inprogress'"
                                                class="btn btn-light btn-active-light-primary btn-sm isDisabled"
                                                data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
                                                <span class="svg-icon svg-icon-5 m-0">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none">
                                            ...
                                            <a v-else class="btn btn-light btn-active-light-primary btn-sm "
                                                data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
                                                <span class="svg-icon svg-icon-5 m-0">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown  menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a class="menu-link px-3 "
                                                        v-if="permissionFields['plan_add_lesson'] == true && dataZipLesson.status == 'waitting'"
                                                        @click="addLessonPackage(tabLessonContent)">Add lesson</a>
                                                    <a class="menu-link px-3 isDisabled"
                                                        v-if="permissionFields['plan_add_lesson'] == false && dataZipLesson.status == 'waitting'"
                                                        @click="addLessonPackage(tabLessonContent)">Add lesson</a>
                                                </div>
                                                <div class="menu-item px-3" v-if="dataZipLesson.status == 'waitting'">
                                                    <a v-if="checkZipPackage[0].lessonIds.length > 0 && permissionFields['plan_zip_package_lesson'] == true"
                                                        class="menu-link px-3" @click="downloadLesson(tabLessonContent)">Zip
                                                        lesson package</a>
                                                    <a v-else class="menu-link px-3 isDisabled">Zip lesson package</a>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <a class="menu-link px-3 "
                                                        v-if="permissionFields['plan_rename_lesson_package'] == true"
                                                        @click="renameLessonPackage(tabLessonContent)">Rename lesson
                                                        package</a>
                                                    <a class="menu-link px-3 isDisabled" v-else
                                                        @click="renameLessonPackage(tabLessonContent)">Rename lesson
                                                        package</a>
                                                </div>
                                                <div class="menu-item px-3"
                                                    v-if="permissionFields['plan_delete_lesson_package'] == true && dataZipLesson.status == 'done' || permissionFields['plan_delete_lesson_package'] == true && dataZipLesson.status == 'waitting'">
                                                    <a class="menu-link px-3 text-danger "
                                                        @click="deletePackageLessonModal(tabLessonContent)">Delete lesson
                                                        package</a>
                                                </div>
                                                <div class="menu-item px-3"
                                                    v-if="permissionFields['plan_delete_lesson_package'] == false && dataZipLesson.status == 'done' || permissionFields['plan_delete_lesson_package'] == false && dataZipLesson.status == 'waitting'">
                                                    <a class="menu-link px-3 text-danger isDisabled"
                                                        @click="deletePackageLessonModal(tabLessonContent)">Delete lesson
                                                        package</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex flex-stack pt-4 pl-9 pr-9">
                                            ...
                                            <div class="badge badge-lg badge-light-dark mb-15"
                                                style="margin-top:-65px;margin-left:-30px">
                                                ...
                                                <thead
                                                    ...
                                                    <tr>
                                                        <td width="25">
                                                            <div
                                                                class="form-check form-check-sm form-check-custom form-check-solid">
                                                                <input v-if="dataZipLesson.status == 'waitting'"
                                                                    :disabled="permissionFields['plan_remove_lesson'] == false"
                                                                    class="form-check-input" type="checkbox"
                                                                    v-model="allViewLessonSelected.allViewLessonSelected"
                                                                    @change="selectViewLessonAll(tabLessonContent)">
                                                                <input v-if="dataZipLesson.status != 'waitting'" disabled
                                                                    class="form-check-input" type="checkbox"
                                                                    v-model="allViewLessonSelected.allViewLessonSelected"
                                                                    @change="selectViewLessonAll(tabLessonContent)">
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr v-for="(lesson, index) in dataAddLessonPlan">
                                                        <td class="">
                                                            <div
                                                                ...
                                                                <input v-if="dataZipLesson.status == 'waitting'"
                                                                    :disabled="permissionFields['plan_remove_lesson'] == false"
                                                                    class="form-check-input" type="checkbox"
                                                                    v-model="dataTableLesson.viewLesson" :value="lesson.id"
                                                                    @change="updateViewLessonCheckAll()">
                                                                <input v-if="dataZipLesson.status != 'waitting'" disabled
                                                                    class="form-check-input" type="checkbox"
                                                                    v-model="dataTableLesson.viewLesson" :value="lesson.id"
                                                                    @change="updateViewLessonCheckAll()">
                                                        ...
                                                        <td class="">
                                                            ...
                                                            <button v-if="dataZipLesson.status == 'waitting'"
                                                                :disabled="permissionFields['plan_remove_lesson'] == false"
                                                                class="btn btn-active-danger btn-light-danger btn-sm"
                                                                @click="deleteLessonModal(lesson.id)">Delete</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                    ...
                    <div class="mt-3 mb-5" style="margin-left: 18px">
                        <button type="button" @click="save()" class="btn btn-primary mr-2" :disabled="!permissions['040']">
                            <i class="fa fa-save"></i> Save plan
                        </button>
                        <button type="button" class="btn btn-primary mr-2" @click="exportPlan" :disabled="!permissionFields['plan_export_plan']">
                            <i class="fa fa-file-export"></i>Export plan
                        </button>
                        <button type="button" @click="backIndex()" class="btn btn-secondary">Cancel</button>
            ...
            <div class="modal-dialog modal-dialog-centered popup-main-1" role="document" style="max-width: 500px;">
                <div class="modal-content box-shadow-main paymment-status" style="margin-right:20px; left:140px">
                    ...
                    <div class="px-10 py-5 text-left">
                        ...
                        <span v-if="deviceExpireDate != ''" class="svg-icon svg-icon-2 svg-icon-lg-1 me-0"
                            @click="deviceExpireDateClear">
                            <svg type="button" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" style="float: right;margin: -45px 3px 0px;">
                                <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1"
                                    transform="rotate(-45 6 17.3137)" fill="black" style="fill:red" />
                                <rect x="7.41422" y="6" width="16" height="2" rx="1" transform="rotate(45 7.41422 6)"
                                    fill="black" style="fill:red" />
                            </svg>
                        </span>
                        <error-label for="f_category_id" :errors="errors.deviceExpireDate"></error-label>

                        <input type="text" class="form-control " placeholder="Enter the device name" aria-label=""
                            style="margin-bottom: 10px" aria-describedby="basic-addon1" v-model="deviceName">
            ...
            <div class="modal-dialog modal-dialog-centered popup-main-1" role="document" style="max-width: 500px;">
                <div class="modal-content box-shadow-main paymment-status" style="margin-right:20px; left:140px;">
                    ...
                    <div class="btn btn-sm btn-icon btn-active-color-primary " data-bs-dismiss="modal"
                        style="margin-left: 440px;cursor: pointer;width: 50px;height: 50px">
                    ...
                    <div class="px-10 py-5 text-left">
                        ...
                        <input type="text" class="form-control " placeholder="Enter the device name" aria-label=""
                            style="margin-bottom: 10px" aria-describedby="basic-addon1" v-model="dataDeviceEdit.name">
                    ...
                    <div class="form-group d-flex justify-content-center">
                        <!--                        <button  class="btn btn-danger ito-btn-small" data-dismiss="modal" @click="save()">Add now</button>-->
                        <button class="btn btn-primary ito-btn-add mr-3" data-dismiss="modal"
                            @click="saveEditDevice(dataDeviceEdit)">Save
                        </button>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="w-100">
                                                    ...
                                                    <div class="fv-row mb-10">
                                                        ...
                                                        <div v-if="valueValidateImportDevice == 0"
                                                            ...
                                                            <a class="btn btn-light btn-active-light-primary btn-sm"
                                                                data-kt-menu-trigger="click" @click="downloadTemplate()"><i
                                                                    class="bi bi-download mr-2"></i>Download template
                                                                here</a>
                                                    ...
                                                    <div class="fv-row">
                                                        ...
                                                        <label class="d-flex align-items-center fs-5 fw-bold mb-4">
                                                            ...
                                                            <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                                data-bs-toggle="tooltip" title="validation result"></i>
                                                        </label>
                                                    </div>
                                                    <div v-if="valueValidateImportDevice != 0"
                                                            ...
                                                            <div class="text-end">
                                                                <span class="form-check form-check-custom form-check-solid">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="category" value="0" v-model="doNotImport" />
                                                                    <label style="margin: 0px 10px 0px">Import</label>
                                                                    <input class="form-check-input" type="radio"
                                                                        name="category" value="1" v-model="doNotImport" />
                                                                    <label style="margin: 0px 10px 0px"> Do not import
                                                                    </label>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div v-if="valueValidateImportDevice != 0"
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="ms-6">
                                                                ...
                                                                <div class="fw-bold text-muted">{{ deviceError.length }}
                                                                    error
                                                                    record(s)
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="d-flex" v-if="deviceError.length > 0">
                                                            <div class="text-end">
                                                                <div class="fs-7 text-muted">
                                                                    <a @click="exportDeviceError" type="button"
        ...
        <div class="modal fade" style="margin-right:50px;border:2px solid #333333  " id="deleteDevice" tabindex="-1"
            role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered popup-main-1" role="document" style="max-width: 450px;">
                <div class="modal-content box-shadow-main paymment-status"
                    style="left:120px;text-align: center; padding: 20px 0px 55px;">
                    ...
                    <div class="swal2-actions">
                        <button type="submit" id="kt_modal_new_target_submit" class="swal2-confirm btn fw-bold btn-danger"
                            @click="removeDevice(deleteDevice)">
        ...
        <div class="modal fade" style="margin-right:50px;border:2px solid #333333  " id="deleteLesson" tabindex="-1"
            role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered popup-main-1" role="document" style="max-width: 450px;">
                <div class="modal-content box-shadow-main paymment-status"
                    style="left:120px;text-align: center; padding: 20px 0px 55px;">
                    ...
                    <div class="swal2-actions">
                        <button type="submit" id="kt_modal_new_target_submit" class="swal2-confirm btn fw-bold btn-danger"
                            @click="deleteLesson(deleteLessons)">
                            <span class="indicator-label">Yes, delete!</span>
                        </button>
                        <button type="reset" id="kt_modal_new_target_cancel"
                            class="swal2-cancel btn fw-bold btn-active-light-primary" data-bs-dismiss="modal"
        ...
        <div class="modal fade" style="margin-right:50px " id="addNamePackageLesson" tabindex="-1" role="dialog"
            aria-labelledby="addNamePackageLesson" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered popup-main-1" role="document" style="max-width: 500px;">
                <div class="modal-content box-shadow-main paymment-status" style="margin-right:20px; left:140px">
                    <div class="close-popup" data-dismiss="modal"></div>
                    ...
                    <div class="px-10 py-5 text-left">
                        ...
                        <input type="text" class="form-control " placeholder="Enter the lesson package name" aria-label=""
                            style="margin-bottom: 10px" aria-describedby="basic-addon1" v-model="packageLessonName">
                        <error-label for="f_category_id" :errors="errors.packageLessonName"></error-label>
                    </div>
                    <div class="form-group d-flex justify-content-center">
                        <button class="btn btn-primary ito-btn-add mr-3" data-dismiss="modal"
                            @click="addPackageLesson(tabLessonContent)">
                            Save
                        </button>
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button>
                    </div>
                ...
                <div class="modal-content box-shadow-main paymment-status"
                    ...
                    <div class="swal2-actions">
                        <button type="submit" id="kt_modal_new_target_submit1" class="swal2-confirm btn fw-bold btn-danger"
                            @click="deletePackageLesson(deletePack)">
                            <span class="indicator-label">Yes, delete!</span>
                        </button>
...
<script>
import { $get, $post, forEach, getTimeRangeAll,clone } from "../../utils";
