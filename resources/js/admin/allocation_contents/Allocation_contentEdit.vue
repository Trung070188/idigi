<template>
    <div class="container-fluid">
        <ActionBar type="index" :breadcrumbs="breadcrumbs" title="Allocation detail" />
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="card-body d-flex flex-column">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="f_title" :disabled="!permissionFields['allocation_title']"
                                        v-model="entry.title" name="name" class="form-control" placeholder="title">
                                ...
                                <div class="form-group">
                                    ...
                                    <treeselect :options="allCourses" :multiple="true" @deselect="deleteCourse"
                                        v-model="total_course" @input="selectTotalCourse"
                                        :disabled="!permissionFields['allocation_course']" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12" style="display: flex ;margin: 16px 0px 0px"
                                v-for="number_course in total_course">
                                <div v-for="course in courses" v-if="number_course == course.id"
                                    style="display: flex;align-items: center;flex-basis: 10%"> {{ course.label }}</div>
                                <div v-for="course in courses" v-if="number_course == course.id" style="flex-basis: 90%">
                                    <treeselect :options="course.units" :multiple="true" v-model="course.total_unit"
                                        @input="selectTotalUnit(course)"
                                        :disabled="!permissionFields['allocation_unit']" />
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <treeselect :options="schools" :multiple="true" v-model="school" :disabled="!permissionFields['allocation_school']" />
                                    <error-label for="f_total_course" :errors="errors.total_course"></error-label>
                                </div>
                        ...
                        <div>
                            <button type="reset" @click="save()" class="btn btn-primary mr-2" :disabled="!permissions['036']"><i
