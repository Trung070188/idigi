<template>
    <div class="container-fluid" >
        <ActionBar type="index"
                   createUrl="/xadmin/allocation_content_courses/create"
                   title="Allocation_content_courseIndex"/>
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="card-body d-flex flex-column" >
                        ...
                        <table class=" table  table-head-custom table-head-bg table-vertical-center">
                            ...
                            <tr v-for="entry in entries" @click="edit(entry.id, $event)">
                                ...
                                <td class="">
<!--                                    <a :href="'/xadmin/allocation_content_courses/edit?id='+entry.id" style="margin-right: 10px"><i style="font-size:1.3rem" class="fa fa-edit"></i></a>-->
...
<script>
    ...
    export default {
        name: "Allocation_content_coursesIndex.vue",
        ...
        methods: {
            edit: function (id, event){
                if (!$(event.target).hasClass('deleted')){
                    window.location.href='/xadmin/allocation_content_courses/edit?id='+ id;
                }

            },
            async load() {
                let query = $router.getQuery();
                const res  = await $get('/xadmin/allocation_content_courses/data', query);
            ...
            async remove(entry) {
                ...
                const res = await $post('/xadmin/allocation_content_courses/remove', {id: entry.id});
            ...
            async toggleStatus(entry) {
                const res = await $post('/xadmin/allocation_content_courses/toggleStatus', {
                    id: entry.id,
                    status: entry.status
                });
